...
First, Connect your wallet ([Mainnet](../using_testnet) / [Testnet](../using_testnet)) to the <EnvText envKey="networkName"/> to the <EnvText envKey="projectName"/> Bridge. Make sure you've already switched the network to <EnvText envKey="networkName"/>.
...
1. Click on the Txn Hash itself, it will jump to <EnvLink envKey="l2Explorer">transaction detials page</EnvLink>.
