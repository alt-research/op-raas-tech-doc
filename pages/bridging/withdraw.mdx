...
To bridge funds from Xterio Chain you can use our Bridge ([Mainnet](https://bridge.xter.io/withdraw) / [Testnet](https://op-bridge.alt.technology/withdraw?id=1637450)). The whole process requires two steps, the two-step withdrawal process is designed to ensure the safety and integrity of cross-chain transactions.

## Step 1: Initiate withdrawal

First, Connect your wallet ([Mainnet](../using_mainnet) / [Testnet](../using_testnet)) to the Xterio Bridge. Make sure you've already switched the network to Xterio Chain.
...
<img src="/bridgeout.png" width="500" />
  
When the transaction is successful, the transaction details can be seen by clicking on the **View recent transactions**.

<img src="/withdraw_details.png" width="800" />

1. Click on the Txn Hash itself, it will jump to [XterScan](https://xterscan.io) Transaction Detials page.
...
<img src="/withdrawal_status_1.png" width="500" />
...
<img src="/withdrawal_status_2.png" width="500" />
...
The challenge period may last for **7 days**.

<img src="/withdrawal_status_3.png" width="500" />
...
<img src="/withdrawal_status_4.png" width="500" />
<br/>
You should see the funds in your wallet on the BSC network shortly. 

<img src="/withdrawal_status_5.png" width="500" />
